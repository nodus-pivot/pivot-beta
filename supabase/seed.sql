...
values
  ('a0000000-0000-4000-8000-000000000001', 'Nodus', 'nodus', 'NW', 'customerservice@noduswatches.com', 'Nodus Service Team', false),
  ('a0000000-0000-4000-8000-000000000002', 'Connexus', 'connexus', 'CX', null, null, false)
...
values
  ('a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000001', 'Sector Deep', null, 24),
  ('a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000001', 'Avalon II', null, 24)
on conflict (id) do nothing;
...
values
  ('a0000000-0000-4000-8000-000000000201', 'a0000000-0000-4000-8000-000000000001', 'CT-SD-01',  'Casetube',              'crown_tube',  8.00,  5),
...
values
  ('a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000201'),
  ('a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000202'),
  ('a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000203'),
...
values
  ('a0000000-0000-4000-8000-000000000301', 'a0000000-0000-4000-8000-000000000201', 2,  'initial_count', 8.00,  'demo seed'),
  ('a0000000-0000-4000-8000-000000000302', 'a0000000-0000-4000-8000-000000000202', 11, 'initial_count', 12.00, 'demo seed'),
...
insert into tickets (id, ticket_number, workspace_id, brand_id, stage, customer_name, customer_email, watch_id, watch_serial,
                     ...
                     repair_complete, testing_checks, closed_at, created_at, updated_at, parts_requested_at)
values
  ('a0000000-0000-4000-8000-000000000401', 'NW260041', 'a0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000011',
   'received', 'Maria Lopez', 'maria@example.com', 'a0000000-0000-4000-8000-000000000101', '501122',
   'Second hand stutters and the watch loses about two minutes a day.', false, false, null, '[]', '[]',
   false, '{"timekeeping": false, "water_resistance": false, "visual": false}', null, now() - interval '2 days', now() - interval '2 days', null),
  ...
  ('a0000000-0000-4000-8000-000000000403', 'NW260035', 'a0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000011',
   ...
   '[{"component": "bezel_insert", "conditions": ["Cracked"]}, {"component": "case", "conditions": ["Scratches"]}]',
   '[{"component": "bezel_insert", "action": "replace", "variant": "ceramic"}]',
   false, '{"timekeeping": false, "water_resistance": false, "visual": false}', null, now() - interval '10 days', now(), null),
  ('a0000000-0000-4000-8000-000000000404', 'NW260031', 'a0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000011',
   'testing', 'Sarah Chen', 'sarah@example.com', 'a0000000-0000-4000-8000-000000000102', '0303291',
   ...
   true, '{"timekeeping": true, "water_resistance": false, "visual": false}', null, now() - interval '15 days', now() - interval '1 day', null),
  ('a0000000-0000-4000-8000-000000000405', 'NW260027', 'a0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000011',
   'shipped_back', 'Leo Park', 'leo@example.com', 'a0000000-0000-4000-8000-000000000101', '5090169',
   ...
   true, '{"timekeeping": true, "water_resistance": true, "visual": true}', null, now() - interval '21 days', now() - interval '3 days', null),
  ('a0000000-0000-4000-8000-000000000406', 'NW260019', 'a0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000011',
   'closed', 'Tom Reyes', 'tom@example.com', 'a0000000-0000-4000-8000-000000000102', '096/100',
...
values
  ('a0000000-0000-4000-8000-000000000501', 'a0000000-0000-4000-8000-000000000402', 'a0000000-0000-4000-8000-000000000204',
...
where id between 'a0000000-0000-4000-8000-000000000401' and 'a0000000-0000-4000-8000-000000000406'
