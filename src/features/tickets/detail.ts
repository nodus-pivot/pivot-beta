...
export function asCategories(v: unknown): RepairCategory[] {
  if (!Array.isArray(v)) return [];
  return v
    .filter((c): c is { component: string; action?: unknown; variant?: unknown; has_part?: unknown; planned?: unknown; done?: unknown; done_at?: unknown } => !!c && typeof c === "object" && typeof (c as { component?: unknown }).component === "string")
    .map((c) => ({
      ...
      has_part: typeof c.has_part === "boolean" ? c.has_part : undefined,
